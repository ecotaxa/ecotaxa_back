    ...
    def acquire(self, blocking: bool = True) -> bool:
        ...
        try:
            ...
            try:
                ...
                logger.warning(
                    f"Failed to truncate lock file {self.lock_file_path}: {e}"
                )
            ...
            try:
                ...
                logger.warning(
                    f"Failed to write PID to lock file {self.lock_file_path}: {e}"
                )
...
def acquire_upload_lock(
    upload_path: str, locks_dir: Optional[str] = None, blocking: bool = True
):
    """
