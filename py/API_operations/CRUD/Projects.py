...
from BO.ProjectSet import FeatureConsistentProjectSet, ProjectSetColumnStats, LimitedInCategoriesProjectSet
...
class ProjectsService(Service):
    ...
    def read_columns_stats(self, current_user_id: int,
                           ...
                           categories: List[ClassifIDT]) -> ProjectSetColumnStats:
        """
