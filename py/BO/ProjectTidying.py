...
class ProjectTopology(object):
    ...
    def add_association(
        ...
        if acquisition_orig_id not in acqs_for_sample:
            ...
            parent_samples = self.acquisition_parents.setdefault(
                acquisition_orig_id, set()
            )
