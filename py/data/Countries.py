...
# from https://github.com/flyingcircusio/pycountry/blob/master/src/pycountry/databases/iso3166-1.json
_json_iso = """
{
  "3166-1": [
    {
...
_iso = json.loads(_json_iso)
_norm = _iso["3166-1"]
countries_by_name = {a_country["name"]: a_country for a_country in _norm}
