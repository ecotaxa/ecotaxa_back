...
from API_models.helpers.TypedDictToModel import TypedDict2Pydantic
...
class _ProjectFilters2Model(object):
    description = {
        ...
        "totime": Field(title="To time",
                        ...
                        example="23:32:00"),
        "inverttime": Field(title="Invert time",
...
class ProjectFilters(TypedDict2Pydantic[ProjectFiltersDict, _ProjectFilters2Model]):
    class Config:
        schema_extra = {"title": "Project filters Model",
                        "description": "How to reduce project data."}

    def base(self) -> ProjectFiltersDict:  # TODO: OK this could be part of the generator
        return self.dict()  # type:ignore

# NOK as of 28/02/2022, it looks like the primitive damages the original class
# and our generator adds get() defs anyway
# ProjectFiltersModel = create_model_from_typeddict(ProjectFilters)
