...
class EcoTaxaGenerator(utils.Sequence):
    ...
    Args:
        images_paths (list/ndarray, str): paths to images
    ...
    def augmenter(images):
        """
        Define a data augmenter which does horizontal flip (50% chance),
    ...
    def __getitem__(self, index):
        ...
        for img, its_path in zip(batch_orig_images, batch_paths):
            # self.dbg_save(img, "/tmp/out_raw.jpg")
