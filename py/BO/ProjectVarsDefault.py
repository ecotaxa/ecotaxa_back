...
# TODO: Now Unused
equivalent_ellipsoidal_volume = ProjectVar(
...
# TODO: Now Unused
equivalent_spherical_volume = ProjectVar(
    "4.0/3.0*math.pi*(math.sqrt(area/math.pi)*pixel_size)**3",
    Vocabulary.biovolume,
    Units.cubic_millimetres_per_cubic_metre,
)
