...
class DirectoryEntryModel(BaseModel):
    ...
    """
    name: str = Field(title="Name", description="atomic entry name.",
    ...
    mtime: str = Field(title="Modification time", description="Modification time, in ISO format.",
...
class DirectoryModel(BaseModel):
    ...
    """
    path: str = Field(title="Path", description="A /-separated path from root to this directory.",
                      example="/ftp_plankton/Ecotaxa_Exported_data")
    entries: List[DirectoryEntryModel] = Field(title="Entries",
                                               description="Entries, i.e. subdirectories or contained files."
