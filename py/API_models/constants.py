...
class Constants(BaseModel):
    ...
    license_texts: Dict[str, str] = Field(title="License texts",
                                          ...
                                          example={
                                              ...
                                              "": "Not chosen"})
    app_manager: List[str] = Field(title="Application manager",
    ...
    countries: List[str] = Field(title="Countries", description="List of known countries names.",
                                 default=[], min_items=1, example=["France"])
