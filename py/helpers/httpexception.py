...
DETAIL_SMTP_RECIPIENT_REFUSED = "Recipient refused"
DETAIL_SMTP_DATA_ERROR = "Data error"
DETAIL_SMTP_DISCONNECT_ERROR = "Server disconnection"
DETAIL_SMTP_CONNECT_ERROR = "Server connection error"
DETAIL_SMTP_RESPONSE_ERROR = "Server response error"
