...
HistoricalLastClassificationModel = dataclass_to_model(HistoricalLastClassif, _DBHistoricalLastClassifDescription)
...
class ObjectSetRevertToHistoryRsp(BaseModel):
    ...
    last_entries: List[HistoricalLastClassificationModel] = Field(title="Last entries",
...
class _DBHistoricalClassificationDescription(DescriptiveModel):
    ...
    user_name = Field(title="User name", description="The name of the user who classified this object.",
                      example="null")
    taxon_name = Field(title="Taxon name", description="The taxon name of the object.",
                       example="Penilia avirostris")


HistoricalClassificationModel = dataclass_to_model(HistoricalClassification, _DBHistoricalClassificationDescription)


class ObjectHistoryRsp(BaseModel):
    classif: List[HistoricalClassificationModel] = Field(title="The classification history",
                                                         default=[])
