...
_DBObjectHeaderDescription = {
    ...
    "classif_auto_when": Field(title="Classification auto when",
                               ...
                               example="2021-09-21T14:59:01.007110"),
    "classif_crossvalidation_id": Field(title="Classification crossvalidation Id", description="Always NULL in prod.",
                                        example="null"),
...
_DBImageDescription = {
    ...
    "orig_file_name": Field(title="Original file name", description="The file name of the original image.", example="dewex_leg2_63_689.jpg"),
    ...
    "thumb_file_name": Field(title="Thumb file name", description="Generate thumbnail if image is too large. This generated thumbnail file name.", example="null"),
    "thumb_width": Field(title="Thumb width", description="Generate thumbnail if image is too large. This generated thumbnail width.", example="null"),
    "thumb_height": Field(title="Thumb height", description="Generate thumbnail if image is too large. The thumb height of the image.", example="null")
}
...
class ObjectSetSummaryRsp(ResponseModel):
    ...
    """
    total_objects: Optional[int] = Field(title="Total objects", description="Total number of objects in the set.", default=None, example=300)
...
_DBHistoricalLastClassifDescription = {
    "objid": Field(title="Object Id", description="The object Id.", example=264409236),
    "classif_id": Field(title="Classification Id", description="The classification Id.", example=82399),
    "histo_classif_date": Field(title="Historical last classification date", description="The classification date.", example="2021-09-21T14:59:01.007110"),
    "histo_classif_type": Field(title="Historical last classification type", description="The type of classification. Could be **A** for Automatic or **M** for Manual.", example="M"),
    "histo_classif_id":  Field(title="Historical last classification Id", description="The classification Id.", example=56),
    "histo_classif_qual": Field(title="Historical last classification qualification", description="The classification qualification. Could be **P** for predicted, **V** for validated or **D** for Dubious.", example="V"),
    "histo_classif_who": Field(title="Historical last classification who", description="The user who manualy classify this object.", example=3876),
}

HistoricalLastClassificationModel = dataclass_to_model(HistoricalLastClassif, field_infos=_DBHistoricalLastClassifDescription)
...
class ClassifyReq(BaseModel):
    ...
    wanted_qualification: str = Field(title="Wanted qualification", description="The wanted qualifications for all objects. 'V' or 'P'.", example="V")
